 ...
 * @author remco_vanwilgen@hotmail.com (Remco van Wilgen)
 */
'use strict';
...
// Context menus.
Blockly.MSG_DUPLICATE_BLOCK = 'Kopiëren';
Blockly.MSG_REMOVE_COMMENT = 'Verwijder commentaar';
Blockly.MSG_ADD_COMMENT = 'Voeg commentaar toe';
Blockly.MSG_EXTERNAL_INPUTS = 'Externe Inputs';
Blockly.MSG_INLINE_INPUTS = 'In lijn Inputs';
Blockly.MSG_DELETE_BLOCK = 'Verwijder Block';
Blockly.MSG_DELETE_X_BLOCKS = 'Verwijder %1 Blocks';
Blockly.MSG_COLLAPSE_BLOCK = 'Voeg block samen';
Blockly.MSG_EXPAND_BLOCK = 'Klap block uit';
Blockly.MSG_DISABLE_BLOCK = 'Zet block uit';
Blockly.MSG_ENABLE_BLOCK = 'Zet block aan';
Blockly.MSG_HELP = 'Help';

// Variable renaming.
Blockly.MSG_CHANGE_VALUE_TITLE = 'Verander waarde:';
Blockly.MSG_NEW_VARIABLE = 'Nieuwe variabele...';
Blockly.MSG_NEW_VARIABLE_TITLE = 'Nieuwe variabele naam:';
Blockly.MSG_RENAME_VARIABLE = 'Hernoem variabele...';
Blockly.MSG_RENAME_VARIABLE_TITLE = 'Hernoem alle "%1" variabelen tot:';

// Toolbox.
Blockly.MSG_VARIABLE_CATEGORY = 'Variabelen';
Blockly.MSG_PROCEDURE_CATEGORY = 'Proceduren';

// Colour Blocks.
Blockly.LANG_CATEGORY_COLOUR = 'Kleur';
Blockly.LANG_COLOUR_PICKER_HELPURL = 'http://nl.wikipedia.org/wiki/Kleur';
Blockly.LANG_COLOUR_PICKER_TOOLTIP = 'Kies een kleur van het palet';

Blockly.LANG_COLOUR_RGB_HELPURL = 'http://en.wikipedia.org/wiki/RGB_color_model';
Blockly.LANG_COLOUR_RGB_TITLE = 'kleur met';
Blockly.LANG_COLOUR_RGB_RED = 'rood';
Blockly.LANG_COLOUR_RGB_GREEN = 'groen';
Blockly.LANG_COLOUR_RGB_BLUE = 'blauw';
Blockly.LANG_COLOUR_RGB_TOOLTIP = 'Maak een kleur met een specifiek aantal rood, groen,\n' +
    'en blauw. Alle waarden moeten tussen 0.0 en 1.0. zijn';

Blockly.LANG_COLOUR_BLEND_TITLE = 'meng';
Blockly.LANG_COLOUR_BLEND_COLOUR1 = 'kleur 1';
Blockly.LANG_COLOUR_BLEND_COLOUR2 = 'kleur 2';
Blockly.LANG_COLOUR_BLEND_RATIO = 'verhouding';
Blockly.LANG_COLOUR_BLEND_TOOLTIP = 'Meng twee kleuren met de volgende verhouding(0.0 - 1.0).';
